function Sound() {
  var itworks=false;
  var wavenames="bravo,endingstart,erase1,erase2,erase3,erase4,gameover,garbage,lock,tspin0,tspin1,tspin2,tspin3,combo1,combo2,combo3,combo4,combo5,combo6,combo7,combo8".split(",");
  var waves={};
  this.init=function(){
    if(itworks===false){
      try{
